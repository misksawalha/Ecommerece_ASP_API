...
namespace Ecommerce.Infrastructer.Migrations
{
    ...
    public partial class firstmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "LocalUserId", "OrderDate", "OrderStatus", "OrdersId" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 12, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "Pending", null },
                    { 2, 2, new DateTime(2023, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Completed", null },
                    { 3, 1, new DateTime(2023, 12, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "Shipped", null }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Image", "Name", "Price", "PriceTotal" },
                values: new object[,]
                {
                    { 1, 1, "smartphone.jpg", "Smartphone", 299.99m, 0m },
                    { 2, 1, "laptop.jpg", "Laptop", 799.99m, 0m },
                    { 3, 2, "novel.jpg", "Novel", 19.99m, 0m },
                    { 4, 3, "tshirt.jpg", "T-Shirt", 9.99m, 0m },
                    { 5, 3, "jeans.jpg", "Jeans", 49.99m, 0m }
                });
